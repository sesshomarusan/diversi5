--[[
    ...
    Dungeon Crawler Framework Documentation
    ========================

    Use this framework to kickstart your dungeon, adventure or RPG game creation.
    The framework includes the most basic features you need to design your dungeons and create more complex gameplay systems.
    ...
    5. Once you upgraded your weapon, you can explore next harder dungeons.
       ...
       Alternatively, you can also try aiming to earn enoigh Coins to buy the final costume called "Lava Elemental Costume".
    ...
    Note: The Lobby area is also a place that showcases fantasy props provided by Core.
    ...
    Quick Start Guide
    Drag out the weapons listed below into the hierarchy to understand their structure and abilities:
    - Basic Dagger
    - Basic Blade
    - Basic Sword
    ...
    Additionally, this framework has a few more customized weapons that serve as examples of weapon kitbashing:
    - Icy Blade
    - Fiery Sword
    - Mace and Shield
    - Poison Crossbow
    ...
    Start creating new weapons based on existing weapons in the framework or alter them to your needs.

    Note:
    - Block ability on "Basic Sword and Shield" and "Mace and Shield" broadcasts events to BlockAbilityDisplayClient that is located in Hierarchy.
      The script triggers block UI to show the cast duration phase for block ability.

    Getting Started - Costumes
    ========================

    Costumes can be equipped and be persistent like weapons.
    Costumes by default are purchasable from the Costumes Shop in Lobby area.

    To modify a costume, follow these steps:
    1. Drag any template with name ending " Costume" to the hierarchy from Project Content.
    2. Deintance the costume template.
    3. Tick / untick "IsPlayerVisible" if you want the player to be visible or not when wearing the costume.
    4. Go to Client Context > Costume to edit the costume under each folder with player socket names.

    There are a lot more costumes you can integrate from Community Content.
    ...
    To learn more about NPC AI Kit, read the script called "DocumentationNPCKit"
      under "Framework Documentation" folder in the hierarchy.

    Getting Started - Player Level Progression
    ========================

    This framework introduces basic Level and XP as a concept.
    ...
    If you want a more complex level progression, you can edit the BasicLevelProgression scripts to follow a formula instead of the "Levels List" table.
    ...
    9. You're ready to try out the new map!

    Note: Alternatively, you can hide / delete the whole map and start with a fresh map.
